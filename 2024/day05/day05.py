            ...
            for update in updates:
                if update in update_to_children:
                    ...
                    if all([prev_update not in children_updates for prev_update in prev_updates]):
                        ...
                        correct = False
                        incorrect_prev_updates = [prev_update for prev_update in prev_updates if prev_update in children_updates]
